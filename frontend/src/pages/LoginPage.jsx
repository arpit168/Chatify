...
import { MessageCircleIcon, MailIcon, LoaderIcon, LockIcon, EyeIcon, EyeOffIcon, SparklesIcon } from "lucide-react";
...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-3 sm:p-4 relative overflow-hidden" style={{ background: "var(--bg-app)" }}>
      {/* Animated background elements - responsive opacity */}
      ...
      <div className="relative w-full max-w-6xl animate-fadeIn">
        <BorderAnimatedContainer>
          <div className="w-full flex flex-col md:flex-row backdrop-blur-sm bg-slate-900/50 rounded-xl sm:rounded-2xl overflow-hidden">
              ...
              <div className="w-full max-w-md">
                ...
                <div className="text-center mb-6 sm:mb-8">
                  <div className="relative inline-block">
                    <div className="absolute inset-0 bg-linear-to-r from-cyan-400 to-purple-500 rounded-full blur-xl opacity-50"></div>
                    <MessageCircleIcon className="relative w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 mx-auto text-transparent bg-linear-to-r from-cyan-400 to-purple-500 bg-clip-text mb-3 sm:mb-4" />
                  </div>
                  <h2 className="text-2xl sm:text-3xl font-bold bg-linear-to-r from-slate-100 to-slate-300 bg-clip-text text-transparent mb-1 sm:mb-2">
                    Welcome Back
                  </h2>
                  <p className="text-xs sm:text-sm text-slate-400">Login to access your account</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 md:space-y-6">
                  ...
                  <div className="text-right">
                    <button type="button" className="text-xs sm:text-sm text-slate-400 hover:text-cyan-400 transition-colors duration-300">
                      Forgot Password?
                    </button>
                  </div>
                ...
                <div className="mt-4 sm:mt-6 text-center">
                  <Link to="/signup" className="text-xs sm:text-sm text-slate-400 hover:text-cyan-400 transition-all duration-300 inline-flex items-center gap-2 group">
            ...
            {/* FORM ILLUSTRATION - RIGHT SIDE - Hidden on mobile */}
            <div className="hidden md:flex md:w-1/2 items-center justify-center p-6 lg:p-10 bg-linear-to-br from-slate-800/30 to-purple-900/20 relative overflow-hidden">
              <div className="relative z-10 animate-slideInRight">
                <div className="relative">
                  <div className="absolute inset-0 bg-linear-to-r from-cyan-400 to-purple-500 rounded-2xl blur-2xl opacity-20"></div>
                  <img
                    src="/login.png"
                ...
                <div className="mt-6 lg:mt-8 text-center">
                  ...
                  <p className="text-slate-400 text-sm lg:text-base mt-2">Experience seamless communication</p>
                  
                  <div className="mt-4 lg:mt-6 flex justify-center gap-2 lg:gap-3 flex-wrap">
                    <span className="px-3 lg:px-4 py-1.5 lg:py-2 bg-linear-to-r from-cyan-500/20 to-purple-500/20 backdrop-blur-sm rounded-full text-cyan-400 text-xs lg:text-sm font-medium border border-cyan-400/30 hover:scale-105 transition-transform duration-300">
                      ✨ Free
                    </span>
                    <span className="px-3 lg:px-4 py-1.5 lg:py-2 bg-linear-to-r from-cyan-500/20 to-purple-500/20 backdrop-blur-sm rounded-full text-cyan-400 text-xs lg:text-sm font-medium border border-cyan-400/30 hover:scale-105 transition-transform duration-300">
                      🚀 Easy Setup
